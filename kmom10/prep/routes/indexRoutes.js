...
router.get("/index", (req, res) => {
    ...
    Thank you for visiting our e-shop. We specialize in providing high-quality coffee and tea products sourced from around the world.
    Whether you're a coffee enthusiast or a tea lover, we have a wide selection of premium blends and single-origin varieties to choose from.
    Explore our collection of freshly roasted coffee beans, aromatic loose-leaf teas, and convenient tea bags. Start your day with the perfect cup of coffee or tea!
    Feel free to browse our catalog and contact us if you have any questions or special requests. We're here to help you discover the perfect brew for every occasion.
    `;
