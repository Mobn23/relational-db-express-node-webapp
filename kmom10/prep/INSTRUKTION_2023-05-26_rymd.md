...
<!--
Du kan läsa detta dokumentet i webbläsaren via länken "[Examination 26 maj 2023](https://dbwebb.se/kurser/databas-v2/kmom10/tentamen/rymd)"
-->
...
1. Skapa routen `/exam/visa` som visar en rapport med alla detaljer om samtliga satelliter inklusive samtliga detaljer om vilken fenomen de bevakar och vilka problem de stött på.
